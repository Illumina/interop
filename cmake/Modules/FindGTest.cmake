...
message("Installing gtest release:" GTEST_TAG)
...
find_library(GTEST_MAIN_LIBRARY_DEBUG
        if(${GTEST_VERSION_NUM} VERSION_LESS_EQUAL "1.8.1")
        NAMES gtest_main-d gtest_maind
        else()
        NAMES gtest_main-d gtest_main
        endif()
        HINTS ${PC_GTEST_INCLUDEDIR} ${PC_GTEST_INCLUDE_DIRS} ${GTEST_ROOT} $ENV{GTEST_DIR}
        PATH_SUFFIXES . lib lib64
)
...
if(NOT GTEST_INCLUDE_DIR OR NOT GTEST_LIBRARY OR NOT GTEST_MAIN_LIBRARY)
    ...
    string(STRIP "${CMAKE_CXX_FLAGS}" CMAKE_CXX_FLAGS_NEW)
    string(REPLACE " " ";" CMAKE_CXX_FLAGS_NEW "${CMAKE_CXX_FLAGS_NEW} -DGTEST_USE_OWN_TR1_TUPLE=${GTEST_USE_OWN_TR1_TUPLE}")
    string(REPLACE ";;" ";" CMAKE_CXX_FLAGS_NEW "${CMAKE_CXX_FLAGS_NEW}")
    string(REPLACE ";;" ";" CMAKE_CXX_FLAGS_NEW "${CMAKE_CXX_FLAGS_NEW}")
    message(STATUS "CMAKE_CXX_FLAGS_NEW=${CMAKE_CXX_FLAGS_NEW}")
    #string(REPLACE ";" "$<SEMICOLON>" CMAKE_CXX_FLAGS_NEW "${CMAKE_CXX_FLAGS_NEW}")
    message(STATUS "CMAKE_CXX_FLAGS_NEW=${CMAKE_CXX_FLAGS_NEW}")
    ...
    ExternalProject_Add(
            ...
            GIT_TAG ${GTEST_TAG}
            CMAKE_ARGS
            "-DCMAKE_CXX_FLAGS=-DGTEST_USE_OWN_TR1_TUPLE=${GTEST_HAS_TR1_TUPLE}"
