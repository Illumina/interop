...
if(NOT GTEST_INCLUDE_DIR OR NOT GTEST_LIBRARY OR NOT GTEST_MAIN_LIBRARY)
    ...
    string(REPLACE ";" "$<SEMICOLON>" CMAKE_CXX_FLAGS_NEW "${CMAKE_CXX_FLAGS};-DGTEST_USE_OWN_TR1_TUPLE=${GTEST_USE_OWN_TR1_TUPLE}")
    ...
    ExternalProject_Add(
            ...
            GIT_TAG ${GTEST_TAG}
            CMAKE_ARGS
            -DCMAKE_CXX_FLAGS=${CMAKE_CXX_FLAGS_NEW}
            -DGTEST_HAS_TR1_TUPLE=${GTEST_HAS_TR1_TUPLE} ${EXTRA_FLAGS} ${UPDATE_CXX11_ABI}
            -G${CMAKE_GENERATOR}
