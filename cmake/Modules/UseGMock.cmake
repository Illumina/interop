...
if(NOT GMOCK_LIBRARY)
    ...
    if(MSVC)
        set_property(TARGET ${GMOCK_LIBRARY} APPEND PROPERTY COMPILE_DEFINITIONS _CRT_SECURE_NO_WARNINGS _SCL_SECURE_NO_WARNINGS _SILENCE_TR1_NAMESPACE_DEPRECATION_WARNING)
    endif()
