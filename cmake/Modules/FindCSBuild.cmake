...
if(CSBUILD_TOOL MATCHES "DotNet|Mono|DotNetCore")
    ...
    find_package( ${CSBUILD_TOOL} )
endif()
if(NOT DOTNET_FOUND AND NOT MONO_FOUND AND NOT DOTNET_CORE_FOUND)
    if(CSBUILD_TOOL)
        message(WARNING "Ignored -DCSBUILD_TOOL=${CSBUILD_TOOL}, it does not match DotNet|Mono|DotNetCore")
    endif()
    if( WIN32 )
        find_package( DotNet )
        if( NOT DOTNET_FOUND )
...
if(CSBUILD_FOUND)
    ...
    if(DOTNET_CORE_FOUND)
        ...
        message(STATUS "Using Platform: v${CSHARP_PLATFORM}")
    endif()
