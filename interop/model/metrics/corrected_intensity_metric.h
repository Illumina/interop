        ...
        namespace model {
            namespace metrics {
                ...
                public:
                     ...
                     */
                    ushort_t corrected_int_called(const constants::dna_bases index)const
                    {
                        INTEROP_ASSERT(index < static_cast<constants::dna_bases>(constants::NUM_OF_BASES));
                     ...
                     */
                    const uint_array_t& called_counts_array()const{return m_called_counts;}
                    /** Average corrected intensity for only base called clusters: A, C, G and T
                     *
                     * @return vector of corrected called intensities
                     */
                    const ushort_array_t& corrected_int_called_array()const{return m_corrected_int_called;}
                    /** Average corrected intensity for each type of base: A, C, G and T
                     *
                     * @note Supported version 2, not supported by 3 or later
                     * @return vector of corrected called intensities
                     */
                    const ushort_array_t& corrected_int_all_array()const{return m_corrected_int_all;}
