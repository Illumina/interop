...
namespace illumina { namespace interop { namespace logic { namespace table
{
     ...
     */
    inline void determine_filled_columns(const model::metrics::run_metrics& metrics,
...
#       undef INTEROP_TUPLE7
     ...
     */
    inline size_t get_column_rounding(const model::table::column_id index)
    {
...
#       undef INTEROP_TUPLE7
     ...
     */
    inline void create_imaging_table_columns(const std::vector<std::string>& channels,
     ...
     */
    inline void populate_column_offsets(std::vector<model::table::imaging_column>& columns)
                                        throw(model::invalid_column_type)
    {
        size_t offset = 0;
     ...
     */
    inline void create_imaging_table_columns(const model::metrics::run_metrics& metrics,
                                             std::vector< model::table::imaging_column >& columns)
    {
        typedef model::metrics::run_metrics::tile_metric_map_t tile_metric_map_t;
        std::vector< bool > filled;
