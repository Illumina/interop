...
#pragma pack(1)
    ...
    /** Image Metric Record Layout Version 3
     *
     * This class provides an interface to reading the image metric file:
     *  - InterOp/ImageMetrics.bin
     *  - InterOp/ImageMetricsOut.bin
     ...
     */
    template<>
    struct generic_layout<image_metric, 3> : public default_layout<3>
    {
        /** @page image_v3 Image Version 3
         *
         * This class provides an interface to reading the image metric file:
         *  - InterOp/ImageMetrics.bin
         *  - InterOp/ImageMetricsOut.bin
         ...
         *          byte 1: record size (8 + 2*channelCount + 2*channelCount)
         *
         *  @b Extended Header
         *
...
INTEROP_REGISTER_METRIC_GENERIC_LAYOUT(image_metric, 3)
