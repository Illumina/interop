...
namespace illumina{ namespace interop { namespace unittest {
    ...
    public:
         ...
         */
        proxy_argument_iterator(T& obj, const proxy_argument_generator<T,Proxy>& base, const_iterator it) : m_base(base), m_begin(it), m_current(it), m_object(obj), p_value(&m_object)
        {
        }
        /** Destructor */
    ...
    {
        return new proxy_argument_iterator<T,Proxy>(m_object, *this, m_vec.begin());
    }
    template<typename T, typename Proxy>
    ::testing::internal::ParamIteratorInterface< typename T::parent_type >* proxy_argument_generator<T,Proxy>::End() const
    {
        return new proxy_argument_iterator<T,Proxy>(m_object, *this, m_vec.end());
    }
