...
struct extraction_metrics_hardcoded_fixture_v2 : util::fixture_helper<extraction_metrics, 2>
{
    ...
    extraction_metrics_hardcoded_fixture_v2()
    {
        ...
        expected_metrics.push_back(metric_type(7, 1114, 1, 9859129975844165472ul, to_vector(p90_1), to_vector(focus1)));
        float focus2[] = {2.23177338f, 2.20616174f, 0, 0};
        ushort_t p90_2[]  = {312, 273, 0, 0};
        expected_metrics.push_back(metric_type(7, 1214, 1, 9859129975872781680ul, to_vector(p90_2), to_vector(focus2)));
        float focus3[] = {2.10524225f, 2.14023066f, 0, 0};
        ushort_t p90_3[]  = {349, 302, 0, 0};
        expected_metrics.push_back(metric_type(7, 2114, 1, 9859129975901427921ul, to_vector(p90_3), to_vector(focus3)));
