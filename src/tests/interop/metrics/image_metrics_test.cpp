...
image_metrics_tests::generator_type image_unit_test_generators[] = {
        ...
        wrap(new by_cycle_metric_generator< image_metric_v3 >),
        wrap(new clear_metric_generator< image_metric_v1 >),
        wrap(new clear_metric_generator< image_metric_v2 >),
        wrap(new clear_metric_generator< image_metric_v3 >)
};
