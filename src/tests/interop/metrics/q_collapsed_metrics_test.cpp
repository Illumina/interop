...
q_collapsed_metrics_tests::generator_type q_collapsed_unit_test_generators[] = {
        ...
        wrap(new clear_metric_generator< q_collapsed_metric_v5 >),
        wrap(new clear_metric_generator< q_collapsed_metric_v4 >),
        wrap(new clear_metric_generator< q_collapsed_metric_v3 >),
        wrap(new clear_metric_generator< q_collapsed_metric_v2 >),
        wrap(new clear_metric_generator< q_collapsed_metric_v6 >),
        wrap(new clear_metric_generator< q_collapsed_metric_no_median_v2 >),
        wrap(new clear_metric_generator< q_collapsed_metric_no_median_v5 >)
