...
namespace illumina{ namespace interop { namespace unittest 
{
    ...
    struct index_metric_v1 : metric_test<model::metrics::index_metric, 1>
    {
        ...
        static void create_binary_data(Collection& buffer)
        {
            ...
            {
                    1
                    ,7,0,90,4,3,0,17,0,65,84,67,65,67,71,65,67,45,65,65,71
                    ,71,84,84,67,65,-38,17,0,0,1,0,49,11,0,84,83,67,65,73,110
                    ,100,101,120,101,115,7,0,-66,4,3,0,17,0,65,67,65,71,84,71,71
                    ,84,45,65,65,71,71,84,84,67,65,125,17,0,0,1,0,50,11,0,84
                    ,83,67,65,73,110,100,101,120,101,115,7,0,66,8,3,0,17,0,67,65
                    ,71,65,84,67,67,65,45,65,65,71,71,84,84,67,65,-30,17,0,0,1
                    ,0,51,11,0,84,83,67,65,73,110,100,101,120,101,115
        ...
        static void create_summary(model::summary::index_flowcell_summary& index_summary)
        {
            ...
            for(size_t lane = 0;lane<index_summary.size();++lane)
            {
                ...
                else
                {
                    ...
                    index_summary[lane].push_back(model::summary::index_count_summary(1, "ATCACGAC", "AAGGTTCA", "1", "TSCAIndexes", 4570, 0.0469f));
                    index_summary[lane].push_back(model::summary::index_count_summary(2, "ACAGTGGT", "AAGGTTCA", "2", "TSCAIndexes", 4477, 0.046f));
