...
{
    base_metric::id_t id = base_cycle_metric::create_id(8, 1323, 2);
    EXPECT_EQ(base_cycle_metric::lane_from_id(id), 8u);

    base_metric::id_t id2 = base_cycle_metric::create_id(1, 1, 2);
...
{
    base_metric::id_t id = base_read_metric::create_id(8, 1323, 2);
    EXPECT_EQ(base_read_metric::lane_from_id(id), 8u);

    base_metric::id_t id2 = base_read_metric::create_id(1, 1, 2);
...
{
    base_metric::id_t id = base_read_metric::create_id(8, 1323, 3);
    EXPECT_EQ(base_read_metric::read_from_id(id), 3u);
}
TEST(base_read_metric_test, tile_hash_from_id)
{
    base_metric::id_t id = base_read_metric::create_id(8, 1323, 10);
