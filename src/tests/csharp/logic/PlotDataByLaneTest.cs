...
namespace illumina.interop.csharp.unittest
{
	...
	public class PlotDataByLaneTest
	{
		...
		public void IntensityTest()
		{
            ...
            c_csharp_interop.read_interop_from_buffer(expected_binary_data, (uint)expected_binary_data.Length, run.tile_metric_set());
            ...
            c_csharp_interop.plot_candle_stick_by_lane(run, metric_type.ClusterCountPF, options, data);
